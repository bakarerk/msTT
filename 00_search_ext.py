...
files = []
start_dir = "C:/"
file_name = "eutraninternfreq" #filters file name if text exists, empty means no filter
pattern   = "*.sql*" # filters by file extention, *.* means no filter
filterby_size_mb = 0 #bring files greater then this size, 0 means no filter
